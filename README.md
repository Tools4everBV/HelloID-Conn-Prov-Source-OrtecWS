...
- **Optional Fields**
  - Private mail, private phonenumber, work phonenumber and parentdepartment are optional and will only be available through the API if it's setting is activated in Ortec
